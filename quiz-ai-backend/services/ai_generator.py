...
def generate_summary(transcript_text):
    """
    Sends the transcript to Groq's Llama model and returns a concise summary (plain text).
    """
...
def generate_quiz(transcript_text, num_questions=5):
    """
    Sends the transcript to Groq's Llama model and asks it to return quiz questions as strict JSON.
